...
func signMessage(address, message string) (string, error) { // 签署信息
	//fmt.Println(id) //0
	//fmt.Println(address) //oYidNmhhCZ76BEKyZJdiqu7YFAURRfSbCJ
	//fmt.Println(message) //QmfJxwEBCbfe5SRQpP1T1jaJrCLMuBSwP8FgpeV54rsPLx-oYidNmhhCZ76BEKyZJdiqu7YFAURRfSbCJ-1605511570
	cmd, err := flojson.NewSignMessageCmd(id, address, message)
	//fmt.Println(cmd) //&{0 oYidNmhhCZ76BEKyZJdiqu7YFAURRfSbCJ QmfJxwEBCbfe5SRQpP1T1jaJrCLMuBSwP8FgpeV54rsPLx-oYidNmhhCZ76BEKyZJdiqu7YFAURRfSbCJ-1605511570}
	//fmt.Println(err) //<nil>
	if err != nil {
		return "", err
	}
	...
	//fmt.Println(reply) //{H+ijZYcFtP3B+FFRnfg1RPmLxJqIybE8qXY8vGY8GpLhBoq57AmHB0DOn6XpQ6kGrKHpE4OPMH5caJ3HwiIykIY= <nil> 0xc420010d10}
	//fmt.Println(err) //<nil>
	if err != nil {
		return "", err
	}
...
func sendToAddress(address string, amount float64, floData string) (string, error) { // 发送信息
	...
	//fmt.Println(id) //0
	//fmt.Println(address) //oYidNmhhCZ76BEKyZJdiqu7YFAURRfSbCJ
	//fmt.Println(satoshi) //10000000
	//fmt.Println(floData) //oip-mp(0,1,oYidNmhhCZ76BEKyZJdiqu7YFAURRfSbCJ,,IImPcZ6HpM8QdrPHWJ3GAVCBsYwGn91BOFFpuNY7qqayEsAzGaGS+1uCHQa3WijN3EaDGlk/LH2mxgmNdUY9sKE=):json:{"oip042":{"publish":{"artifact":{"floAddress":"oYidNmhhCZ76BEKyZJdiqu7YFAURRfSbCJ","timestamp":1605511789,"type":"research","subtype":"tomogram","info":{"title":"testtitle","tags":"etdb,jensen.lab,tomogram,electron.tomography","description":"Auto imported from etdb"},"details":{"date":1577836800,"NCBItaxID":1,"artNotes":"Scope notes: testnotes\nSpecies notes: testnotes\nTilt series notes: testnotes\n","scopeName":"testscope","speciesName":"testsname","strain":"teststrain","tiltSingleDual":1,"defocus":0.1,"dosage":0.3,"tiltMin":0.4,"tiltMax":2,"tiltStep":0.1,"magnification":0.2,"emdb":"testemdb","microscopist":"testuname","institution":"Caltech","lab":"Jensen Lab","sid":"testseries"},"storage":{"network":"ipfs","location":"QmfJxwEBCbfe5SRQpP1T1jaJrCLMuBSwP8FgpeV54rsPLx","files":[{"dname":"testfname.png","fname":"file_123/te
	cmd, err := flojson.NewSendToAddressCmd(id, address, satoshi, "", "", floData)
	//fmt.Println(cmd) //&{0 oYidNmhhCZ76BEKyZJdiqu7YFAURRfSbCJ 10000000   oip-mp(0,1,oYidNmhhCZ76BEKyZJdiqu7YFAURRfSbCJ,,HyitsIDxj619/Umgk7pmXioHNWWKLt9i27KMDp7X7n6HDKG3ftC3WaTW4F3DoSQgXaq3ZGXDdN9B/+ZxIL+ztRk=):json:{"oip042":{"publish":{"artifact":{"floAddress":"oYidNmhhCZ76BEKyZJdiqu7YFAURRfSbCJ","timestamp":1605511863,"type":"research","subtype":"tomogram","info":{"title":"testtitle","tags":"etdb,jensen.lab,tomogram,electron.tomography","description":"Auto imported from etdb"},"details":{"date":1577836800,"NCBItaxID":1,"artNotes":"Scope notes: testnotes\nSpecies notes: testnotes\nTilt series notes: testnotes\n","scopeName":"testscope","speciesName":"testsname","strain":"teststrain","tiltSingleDual":1,"defocus":0.1,"dosage":0.3,"tiltMin":0.4,"tiltMax":2,"tiltStep":0.1,"magnification":0.2,"emdb":"testemdb","microscopist":"testuname","institution":"Caltech","lab":"Jensen Lab","sid":"testseries"},"storage":{"network":"ipfs","location":"QmfJxwEBCbfe5SRQpP1T1jaJrCLMuBSwP8FgpeV54rsPLx","files":[{"dname":"testfname.png","fname":"file_123/te}
	if err != nil {
		return "", err
	}

	reply, err := sendRPC(cmd)
	//fmt.Println(reply) //{c7c51104c17e73ffa502fcbb792e9b05684978ab52de9e682788ca73e637aa07 <nil> 0xc4200d3a90}
	if err != nil {
		return "", err
	}
	if reply.Error != nil {
...
func sendRPC(cmd flojson.Cmd) (flojson.Reply, error) { // 发送RPC调用
	...
	//fmt.Println(server) //localhost:17313
	//fmt.Println(cmd) 
	
	//&{0 oYidNmhhCZ76BEKyZJdiqu7YFAURRfSbCJ QmfJxwEBCbfe5SRQpP1T1jaJrCLMuBSwP8FgpeV54rsPLx-oYidNmhhCZ76BEKyZJdiqu7YFAURRfSbCJ-1605496633}
	//&{0 100000}
	//&{0 oYidNmhhCZ76BEKyZJdiqu7YFAURRfSbCJ 0-1-oYidNmhhCZ76BEKyZJdiqu7YFAURRfSbCJ--json:{"oip042":{"publish":{"artifact":{"floAddress":"oYidNmhhCZ76BEKyZJdiqu7YFAURRfSbCJ","timestamp":1605496633,"type":"research","subtype":"tomogram","info":{"title":"testtitle","tags":"etdb,jensen.lab,tomogram,electron.tomography","description":"Auto imported from etdb"},"details":{"date":1577836800,"NCBItaxID":1,"artNotes":"Scope notes: testnotes\nSpecies notes: testnotes\nTilt series notes: testnotes\n","scopeName":"testscope","speciesName":"testsname","strain":"teststrain","tiltSingleDual":1,"defocus":0.1,"dosage":0.3,"tiltMin":0.4,"tiltMax":2,"tiltStep":0.1,"magnification":0.2,"emdb":"testemdb","microscopist":"testuname","institution":"Caltech","lab":"Jensen Lab","sid":"testseries"},"storage":{"network":"ipfs","location":"QmfJxwEBCbfe5SRQpP1T1jaJrCLMuBSwP8FgpeV54rsPLx","files":[{"dname":"testfname.png","fname":"file_123/te}
	//&{0 oYidNmhhCZ76BEKyZJdiqu7YFAURRfSbCJ 10000000   oip-mp(0,1,oYidNmhhCZ76BEKyZJdiqu7YFAURRfSbCJ,,H1Xd1xQO3Ux7uVhDjl2pCSfaKQ5+KIQRXZq765946lxeBzwORFd1z4ymo2iZr2rH8/cRsah8kGt5Fz4Yf8ZXZgE=):json:{"oip042":{"publish":{"artifact":{"floAddress":"oYidNmhhCZ76BEKyZJdiqu7YFAURRfSbCJ","timestamp":1605496633,"type":"research","subtype":"tomogram","info":{"title":"testtitle","tags":"etdb,jensen.lab,tomogram,electron.tomography","description":"Auto imported from etdb"},"details":{"date":1577836800,"NCBItaxID":1,"artNotes":"Scope notes: testnotes\nSpecies notes: testnotes\nTilt series notes: testnotes\n","scopeName":"testscope","speciesName":"testsname","strain":"teststrain","tiltSingleDual":1,"defocus":0.1,"dosage":0.3,"tiltMin":0.4,"tiltMax":2,"tiltStep":0.1,"magnification":0.2,"emdb":"testemdb","microscopist":"testuname","institution":"Caltech","lab":"Jensen Lab","sid":"testseries"},"storage":{"network":"ipfs","location":"QmfJxwEBCbfe5SRQpP1T1jaJrCLMuBSwP8FgpeV54rsPLx","files":[{"dname":"testfname.png","fname":"file_123/te}
	//&{0 oYidNmhhCZ76BEKyZJdiqu7YFAURRfSbCJ 1-1-oYidNmhhCZ76BEKyZJdiqu7YFAURRfSbCJ-95e127185790cfd456bce3c7f52fd40ce147e2e70388f0c240a50d239fa7b468-stfname.png","fsize":14,"type":"tomogram","subtype":"snapshot","fNotes":"testnotes"},{"software":"testacquisition","dname":"testfname.mp4","fname":"rawdata/testfname.mp4","fsize":14,"type":"tomogram","subtype":"tiltSeries","fNotes":"testfname.mp4"},{"fname":"keyimg_testseries_s.jpg","fsize":24,"type":"image","subtype":"thumbnail","cType":"image/jpeg"},{"fname":"keyimg_testseries.jpg","fsize":24,"type":"tomogram","subtype":"keyimg","cType":"image/jpeg"},{"fname":"keymov_testseries.mp4","fsize":1990544,"type":"tomogram","subtype":"keymov","cType":"video/mp4"},{"fname":"keymov_testseries.flv","fsize":6389760,"type":"tomogram","subtype":"keymov","cType":"video/x-flv"}]},"signature":"H7iLFn++/c/+jRy05+GS3MyOc/VgiYWLChFrc3fN6UrKV37xK8ld+AUH6QiObAjR65sxcp0doVYaQCJ++uF2RZc="}}}}}
	//&{0 oYidNmhhCZ76BEKyZJdiqu7YFAURRfSbCJ 10000000   oip-mp(1,1,oYidNmhhCZ76BEKyZJdiqu7YFAURRfSbCJ,95e127185790cfd456bce3c7f52fd40ce147e2e70388f0c240a50d239fa7b468,H5N74PkBB3w1isue+QsYRMyxVmNKVLLImqGEwBJN8WrdNC8lyKUCAWEpBr3J0LoiYWuc958f6ksSy9K5p3Ivg7o=):stfname.png","fsize":14,"type":"tomogram","subtype":"snapshot","fNotes":"testnotes"},{"software":"testacquisition","dname":"testfname.mp4","fname":"rawdata/testfname.mp4","fsize":14,"type":"tomogram","subtype":"tiltSeries","fNotes":"testfname.mp4"},{"fname":"keyimg_testseries_s.jpg","fsize":24,"type":"image","subtype":"thumbnail","cType":"image/jpeg"},{"fname":"keyimg_testseries.jpg","fsize":24,"type":"tomogram","subtype":"keyimg","cType":"image/jpeg"},{"fname":"keymov_testseries.mp4","fsize":1990544,"type":"tomogram","subtype":"keymov","cType":"video/mp4"},{"fname":"keymov_testseries.flv","fsize":6389760,"type":"tomogram","subtype":"keymov","cType":"video/x-flv"}]},"signature":"H7iLFn++/c/+jRy05+GS3MyOc/VgiYWLChFrc3fN6UrKV37xK8ld+AUH6QiObAjR65sxcp0doVYaQCJ++uF2RZc="}}}}}

	for true {
		reply, err := flojson.RpcSend(user, pass, server, cmd)
		//fmt.Println(reply) 

		//{H7iLFn++/c/+jRy05+GS3MyOc/VgiYWLChFrc3fN6UrKV37xK8ld+AUH6QiObAjR65sxcp0doVYaQCJ++uF2RZc= <nil> 0xc4200103f0}
		//{true <nil> 0xc4200d3460}
		//{H1Xd1xQO3Ux7uVhDjl2pCSfaKQ5+KIQRXZq765946lxeBzwORFd1z4ymo2iZr2rH8/cRsah8kGt5Fz4Yf8ZXZgE= <nil> 0xc420010a80}
		//{95e127185790cfd456bce3c7f52fd40ce147e2e70388f0c240a50d239fa7b468 <nil> 0xc4200d36e0}
		//{H5N74PkBB3w1isue+QsYRMyxVmNKVLLImqGEwBJN8WrdNC8lyKUCAWEpBr3J0LoiYWuc958f6ksSy9K5p3Ivg7o= <nil> 0xc420010d80}
		//{65d3aea6f9b7bc74fd899d57ff6de8692f3fb376f87493a870163a5fa9e8cc84 <nil> 0xc4200d3960}
